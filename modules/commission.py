...
class CommissionModule(object):
    ...
    def __init__(self, config, stats):
        ...
        self.region = {
            ...
            'collect_oil': Region(190, 110, 40, 40),
            'collect_gold': Region(450, 110, 40, 40),
            'collect_book': Region(700, 110, 40, 40),
            'complete_commission': Region(615, 415, 170, 44),
            'button_go': Region(615, 415, 170, 44),
            'urgent_tab': Region(24, 327, 108, 103),
            'daily_tab': Region(22, 185, 108, 103),
            'last_commission': Region(298, 846, 1478, 146),
            'commission_recommend': Region(1306, 490, 185, 85),
            'commission_start': Region(1543, 490, 185, 85),
    ...
    def commission_logic_wrapper(self):
        ...
        while True:
            ...
            alert_available = Utils.find("commission/alert_available", 0.75)
    ...
    def completed_handler(self):
        ...
        while True:
            ...
            if Utils.find("menu/item_found"):
                ...
                Utils.script_sleep(1)
                continue
            if Utils.find("commission/alert_available", 0.85):
